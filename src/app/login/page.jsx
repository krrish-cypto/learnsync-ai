      ...
      <div style={{ 
        ...
        <div className="glass-panel" style={{ width: '100%', maxWidth: '450px', padding: '2.5rem' }}>
          <div className="text-center" style={{ marginBottom: '2rem' }}>
            ...
            <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', marginTop: '0.5rem' }}>Sign in to access your dashboard</p>
          </div>
          ...
          <div style={{ display: 'flex', background: 'var(--surface)', padding: '4px', borderRadius: '8px', marginBottom: '2rem', border: '1px solid var(--surface-border)' }}>
            ...
            <Link href="/signup" style={{ flex: 1, padding: '0.5rem', textAlign: 'center', color: 'var(--text-muted)', textDecoration: 'none', fontWeight: '500' }}>
              Sign Up
            </Link>
          </div>
